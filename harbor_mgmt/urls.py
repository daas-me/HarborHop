...
urlpatterns = [
    ...
    path('payment/<int:booking_id>/stripe-checkout/', views.stripe_checkout, name='stripe_checkout'),
    path('payment/<int:booking_id>/stripe-success/', views.stripe_success, name='stripe_success'),
