"""
Django settings for HarborHop project.
...
WSGI_APPLICATION = 'HarborHop.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'harbor_mgmt', 'static'),
]
...
SESSION_COOKIE_SAMESITE = 'Lax'  # Allow AJAX requests to send session cookie
SESSION_EXPIRE_AT_BROWSER_CLOSE = False

# CSRF Configuration
CSRF_COOKIE_HTTPONLY = False  # Allow JavaScript to read CSRF token
CSRF_COOKIE_SECURE = False  # Set to True in production with HTTPS
CSRF_COOKIE_SAMESITE = 'Lax'  # Allow AJAX requests to send CSRF token
CSRF_TRUSTED_ORIGINS = [
    'http://127.0.0.1:8000',
    'http://localhost:8000',
    'https://harborhop-production.up.railway.app',
